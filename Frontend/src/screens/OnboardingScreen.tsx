...
const ONBOARDING_DATA = [
  {
    ...
    description:
      'Kết nối hàng nghìn game thủ cùng nhịp đập. Không còn chơi solo nếu không muốn.',
    icon: Gamepad2,
  ...
  },
  {
    ...
    description:
      'Tạo phòng (Zone), gắn tag, mời đúng người — đội hình trong mơ gần hơn bạn nghĩ.',
    icon: Crosshair,
  ...
  },
  {
    ...
    description:
      'Lên kế hoạch tác chiến ngay lập tức với hệ thống chat nhóm tốc độ bàn thờ.',
    icon: MessageSquare,
  ...
  },
  {
    ...
    description:
      'Xóa bỏ mọi giới hạn, kề vai sát cánh cùng những người anh em mới để đạt chuỗi thắng bất bại.',
    icon: Trophy,
      ...
      <View style={[styles.slide, { width }]}>
        <View style={styles.imageContainer}>
          ...
          <View style={styles.mascotPlaceholderBox}>
            ...
            />
            <View
              style={[styles.mascotBackGlow, { backgroundColor: item.accent }]}
            />
        ...
        <View style={styles.textContainer}>
          <Text style={[styles.title, { textShadowColor: item.accent }]}>
            {item.title}
          </Text>
